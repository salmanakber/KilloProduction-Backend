      ...
      if (imageFile && imageFile.size > 0) {
        try {
          ...
          if (!allowedTypes.includes(imageFile.type)) {
            errors.push(`Invalid file type: ${imageFile.name}. Only JPG and PNG are allowed.`)
            continue
          }
          ...
          console.log(`✅ Uploaded product image: ${uploadResult.secure_url}`)
