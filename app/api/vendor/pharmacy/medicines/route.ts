...
export async function GET(request: NextRequest) {
  try {
    ...
    if (search) {
      where.OR = [
        { centralMedicine: { name: { contains: search, mode: "insensitive" } } },
        { centralMedicine: { genericName: { contains: search, mode: "insensitive" } } },
        { centralMedicine: { description: { contains: search, mode: "insensitive" } } },
        { centralMedicine: { purpose: { contains: search, mode: "insensitive" } } },
      ]
    }
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!pharmacy.isVerified) {
      return NextResponse.json({ 
        error: "Pharmacy account must be verified before adding medicines",
