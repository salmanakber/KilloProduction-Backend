...
export async function GET(
  ...
  try {
    ...
    // Format the response with enhanced pharmacy profile data
    const quote = {
      id: supplierOrder.id,
      ...
      wholesaler: {
        ...
        description: supplierOrder.wholesaler.description,
        website: supplierOrder.wholesaler.website,
      ...
      pharmacy: {
        ...
        openingHours: supplierOrder.pharmacy.openingHours,
        deliveryZones: supplierOrder.pharmacy.deliveryZones,
